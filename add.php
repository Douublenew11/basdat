            ...
            <form action="" method="post" class="ms-1 mb-1">
                ...
                <div class="card-body">
                    <div class="input-group mb-2">
                        <input type="text" name="nama" placeholder="Masukkan Nama" style="width: 100%; border-radius:4px">
                    </div>
                    <div class="input-group mb-2">
                        <input type="text" name="nik" placeholder="Masukkan NIK" style="width: 100%; border-radius:4px">
                    </div>
                    <div class="input-group mb-2">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" name="kecamatan" placeholder="Masukkan Kecamatan" style="width: 100%; border-radius:4px">
                    </div>
                    <div class="input-group mb-2">
                        <input type="text" name="kota" placeholder="Masukkan Kota" style="width: 100%; border-radius:4px">
                    </div>
                    <div class="input-group mb-2">
                        <input type="text" name="provinsi" placeholder="Masukkan Provinsi" style="width: 100%; border-radius:4px">
                    </div>
